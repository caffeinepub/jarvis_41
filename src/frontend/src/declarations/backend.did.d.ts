...
export interface ChatResult { 'history' : Array<Message>, 'reply' : string }
...
export interface _SERVICE {
  ...
  'hasApiKey' : ActorMethod<[], boolean>,
  'saveApiKey' : ActorMethod<[string], undefined>,
  'saveUserName' : ActorMethod<[string], undefined>,
  'sendMessage' : ActorMethod<[string], ChatResult>,
