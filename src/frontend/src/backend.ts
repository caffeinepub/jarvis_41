...
export class Backend implements backendInterface {
    ...
    async getConversationHistory(): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async hasApiKey(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasApiKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveUserName(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveUserName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: string): Promise<ChatResult> {
        if (this.processError) {
            try {
